                                                     ...
                                                     LEFT JOIN 
                                                               ( 
                                                                      SELECT vendor_tracking_id,
                                                                             max(coalesce(greatest(seller_volumetric_weight, seller_dead_weight, shipment_dead_weight_at_source),non_fa_volumetric_estimate_source)) AS nonfa_billable_weight,
																			 max(IF (shipment_dead_weight_at_source > volumetric_weight, shipment_dead_weight_at_source,volumetric_weight)) AS profiled_billable_weight,
																			 ...
																			 max(shipment_dead_weight_at_source) as profiled_dead_weight_at_source,
																			 max(profiled_volumetric_weight_at_source) as profiled_volumetric_weight_at_source
